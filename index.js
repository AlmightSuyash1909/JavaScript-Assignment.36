...
function isGradeA (person){
  return person.grade > 12
}
...
function isGradeB (person){
  return person.grade > 8 && person.grade <= 12
}
...
function isGradeC (person){
  return person.grade <= 8
}
...
function filteMale(array){
  let final = [];
  for ( let male of array){
    if (isMale(male)){
      final.push(male)
    }
  }
...
function filteFemale(array){
  let final = [];
  for ( let female of array){
    if (isFemale(female)){
      final.push(female)
    }
  }
...
function filteGradeA(array){
  let final = [];
  for ( let gradeA of array){
    if (isGradeA(gradeA)){
      final.push(gradeA)
    }
  }
